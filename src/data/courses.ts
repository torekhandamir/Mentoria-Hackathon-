...
const lessons = (prefix: string, names: string[]) => names.map((name, index) => ({
  ...
  embedUrl: prefix === "economics" ? "https://www.youtube.com/embed/3ez10ADR_gM" : prefix === "cs" ? "https://www.youtube.com/embed/videoseries?list=PLhQjrBD2T381WAHyx1pq-sBfykqMBI7V4" : undefined,
...
export const courses: Course[] = [
  ...
  { id: "cs-ai", title: "Intro to Computer Science & AI", description: "Programming concepts, AI product thinking and portfolio projects.", level: "Beginner", duration: "4 weeks", majorTargets: ["computer-science", "ai-data-science"], tags: ["Programming", "Hackathons", "AI"], sourceUrl: "https://pll.harvard.edu/course/cs50-introduction-computer-science", embedUrl: "https://www.youtube.com/embed/videoseries?list=PLhQjrBD2T381WAHyx1pq-sBfykqMBI7V4", lessons: lessons("cs", ["Computational Thinking", "Scratch / Logic", "C / Programming Basics", "Algorithms", "Final Mini Project"]) },
  { id: "physics-solving", title: "Physics Problem Solving", description: "Mechanics and structured problem-solving for competitions.", level: "Intermediate", duration: "4 weeks", majorTargets: ["physics", "engineering"], tags: ["STEM", "Science", "Olympiads"], lessons: lessons("physics", ["Forces", "Energy", "Momentum"]) },
  { id: "biology-premed", title: "Biology for Pre-Med", description: "Cell biology, genetics and research habits for pre-med students.", level: "Intermediate", duration: "4 weeks", majorTargets: ["medicine", "biology"], tags: ["Science", "Research"], lessons: lessons("biology", ["Cells", "Genetics", "Research summary"]) },
];
